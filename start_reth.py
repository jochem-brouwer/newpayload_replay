...
container_name = "reth-bench"
chain="mainnet"
snapshot_dir = Path("execution-data/reth")
...
def start_reth_container(chain: str, db_dir: Path, jwt_path: Path,
