...
# Code inspired from https://github.com/besuEth/gas-benchmarks
container_name = "besu-bench"
chain="mainnet"
snapshot_dir = Path("execution-data/besu")
...
def start_besu_container(chain: str, db_dir: Path, jwt_path: Path,
    ...
    cmd = [
        ...
        "-e", "BESU_USER_NAME=root", # This is to avoid a massive chown -R
        "--user", "root",
        "hyperledger/besu",
